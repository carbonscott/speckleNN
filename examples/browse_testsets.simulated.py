...
class VizSiameseOutput:
    ...
    def plot_img_anchor(self, title = ""): 
        self.ax_img_anchor.imshow(self.img_anchor, vmax = 255 * 0.2, vmin = 0)
        self.ax_img_anchor.set_title(title)


    def plot_img_pos(self, title = ""): 
        self.ax_img_pos.imshow(self.img_pos, vmax = 255 * 0.2, vmin = 0)
        self.ax_img_pos.set_title(title)


    def plot_img_neg(self, title = ""): 
        self.ax_img_neg.imshow(self.img_neg, vmax = 255 * 0.2, vmin = 0)
...
alpha = 1.0
dim_emb = 32
config_siamese = ConfigSiameseModel(alpha = alpha, size_y = size_y, size_x = size_x, dim_emb = dim_emb)
