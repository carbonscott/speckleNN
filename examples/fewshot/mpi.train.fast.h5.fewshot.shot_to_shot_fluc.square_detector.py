...
from image_preprocess_faulty_sq_with_fluc import DatasetPreprocess
...
timestamp_prev = None
epoch          = None
fl_chkpt       = None if timestamp_prev is None or epoch is None else f"{timestamp_prev}.epoch={epoch}.chkpt"
...
dataset_preproc        = DatasetPreprocess(img_orig, fl_shot_to_shot_fluc = 'image_distribution_by_photon_count.npy')
