...
import logging
import torch
from deepprojection.datasets.cxi_v1  import OnlineDataset      , ConfigDataset
...
fl_csv         = '/reg/data/ana03/scratch/cwang31/play/hit-labeler/labels/2022_0619_1540_27.cxidb_10.label.csv'
...
img_orig, _         = dataset_train.get_cxi_and_label(0)
dataset_preproc     = DatasetPreprocess(img_orig)
trans               = dataset_preproc.config_trans()
dataset_train.trans = trans
img_trans, _        = dataset_train.get_cxi_and_label(0)
