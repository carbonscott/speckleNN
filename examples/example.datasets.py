...
import torch
from deepprojection.datasets.experiments import SPIImgDataset, SiameseDataset
...
dataset_train = SiameseDataset(fl_csv, size_sample, exclude_labels = ['3'], resize = (resize_y, resize_x), debug = debug)
