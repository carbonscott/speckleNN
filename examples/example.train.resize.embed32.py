...
resize_y, resize_x = 4, 4
dataset_train = SiameseDataset(fl_csv, size_sample, resize = (resize_y, resize_x), exclude_labels = ['3'], debug = debug)
...
for i, alpha in enumerate((1.0, )):
    config_siamese = SiameseConfig(alpha = alpha, dim_emb = 32, size_y = size_y, size_x = size_x)
