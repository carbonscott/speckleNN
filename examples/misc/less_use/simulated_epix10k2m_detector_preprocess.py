...
import numpy as np
from deepprojection.datasets.simulated_mosaic import SPIMosaicDataset
...
class DatasetPreprocess:
    ...
    def obtain_data(self):
        ...
        # Get panel size...
        self.spipanel = SPIMosaicDataset(config_dataset)
        self.spipanel.IS_MOSAIC = False
        panels, _ = self.spipanel.get_mosaic_and_label(0)
        self.panel = panels[0]
    ...
    def get_mosaicsize(self):
        """ Once trans rule is applied, the mosaic size will be updated.
        """
        self.spipanel.IS_MOSAIC = True

        # Ensure trans is considered when size is requested...
        self.spipanel.trans = self.trans

        img_mosaic, _ = self.spipanel.get_mosaic_and_label(0)
